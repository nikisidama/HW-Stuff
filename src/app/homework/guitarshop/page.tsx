...
export default function page() {
  ...
  return (<>
    ...
    <main className="bg-white w-full h-screen text-black p-4">
      ...
      <div className={`w-fit h-fit flex justify-center items-center text-black z-30 bottom-0 right-0 bg-white p-4 border-2 border-gray-500 rounded-md ${menu ? 'fixed' : 'hidden'}`}>
    ...
    <footer className="bg-gray-800 text-white p-4">
      ...
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
          <li>
            <a className="text-gray-300/75 transition hover:text-gray-300" href="#"> About </a>
          </li>

          <li>
            <a className="text-gray-300/75 transition hover:text-gray-300" href="#"> Careers </a>
          </li>

          <li>
            <a className="text-gray-300/75 transition hover:text-gray-300" href="#"> History </a>
          </li>

          <li>
            <a className="text-gray-300/75 transition hover:text-gray-300" href="#"> Services </a>
          </li>

          <li>
            <a className="text-gray-300/75 transition hover:text-gray-300" href="#"> Projects </a>
          </li>

          <li>
            <a className="text-gray-300/75 transition hover:text-gray-300" href="#"> Blog </a>
          </li>
        </ul>
